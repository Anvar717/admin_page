      ...
      <div class="modal" role="dialog" aria-modal="true" aria-labelledby="user-modal-title">
        ...
        <div class="modal-header">
          <div class="header-left">
            ...
            <div>
              <h2 id="user-modal-title">{{ t('users.createTitle') }}</h2>
              <span class="modal-subtitle">{{ t('users.createSubtitle') }}</span>
            </div>
          </div>
        ...
        <form class="modal-body" @submit.prevent="handleSubmit">
          ...
          <div class="field">
            ...
            <div class="pill-grid">
              ...
              >
                {{ t(`users.role${role.value.charAt(0).toUpperCase()}${role.value.slice(1)}`) }}
              </button>
            </div>
          </div>
          ...
          <div class="preview-card">
            ...
            <div class="preview-row">
              ...
              <span class="ui-badge" :class="selectedRole.class">
                {{ t(`users.role${form.role.charAt(0).toUpperCase()}${form.role.slice(1)}`) }}
              </span>
            </div>
            <div class="preview-row">
